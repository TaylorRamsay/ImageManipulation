...
class ImageManipulator(Frame):
    ...
    __processedImg = PhotoImage(file=r"C:\\Users\\FSK8475\\Documents\\GitHub\\ImageManipulation\\lib\\Icons\\imageTwo.png")
    ...
    def initButtons(self):
        ...
        self.processedImg = Label(self.middle_frame, image=self.__images[2])
    ...
    def verticalCuts(self):
        ...
        self.processedImg.pack()
        self.__images[2].save("C:\\Users\\FSK8475\\Documents\\GitHub\\ImageManipulation\\lib\\Icons\\Processed\\test.jpg")
